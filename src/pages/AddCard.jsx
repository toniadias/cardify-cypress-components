    ...
    try {
      ...
      if (!canAddCard) {
        setNotification({
          ...
          message: (
            <span>
              Você já cadastrou 3 cartões. Para gerenciar mais cartões,
              considere migrar para o plano Pro.{' '}
              <a
                href="/upgrade"
          ...
          <div className="bg-zinc-900 rounded-2xl p-8">
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                />
                {errors.number && (
                  <p className="alert-error mt-1 text-xs text-red-400 ml-2">
                    {errors.number}
                  </p>
                )}
              </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                  {banks.map((bank) => {
                    return (
                      ...
                      >
                        <div
                          className={`w-16 h-12 flex items-center justify-center mb-3 transition-all duration-300 ${
                            cardData.bank === bank.value
                              ? 'scale-110'
              ...
              {notification.message && (
                <div
                  className={`notice-success rounded-xl p-4 ${
